Pod::Spec.new do |s|
  ...
  s.source_files  = "NemSwift/Sources/ed25519_sha3_512.{c,h}", "NemSwift/Sources/ed25519/src/*.{c,h}", "NemSwift/Sources/RHash/librhash/{ripemd-160,byte_order,sha3}.c", "NemSwift/Sources/RHash/librhash/{ripemd-160,byte_order,sha3,ustd}.h", "NemSwift/NemSwift.h" , "NemSwift/**/*.swift" 
